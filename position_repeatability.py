...
if __name__ == '__main__':
    ...
    # for sweep_num in range(num_sweeps):
        # if (sweep_num % 2) == 0:
            # sweep_position_vs_wavelength('sweep_{}_up.csv'.format(sweep_num),112000,111000,250)
        # else:
            # sweep_position_vs_wavelength('sweep_{}_down.csv'.format(sweep_num),111000,112000,-250)
